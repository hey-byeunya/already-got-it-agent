...
| 경로 | 무엇을 보여주는가 |
|---|---|
| `/` | 모드 배지 · 기간·축·엔진·모델·픽스처로 새 실행 · 추천 4종 · 즐겨찾기 · 지난 실행(10건씩 쪽넘김) · 실행 삭제 |
| `/runs/{id}` | 진행 상태 · 질문 대기 · 승인 대기 · 실행 비용 · 결정 이력 · 카드 차트 · 브리핑 원고 · 실행 로그 · 카드뉴스 내보내기 |
| `GET /api/opencode-models` | 무료 모델 목록 (60초 캐시). 시작 화면의 모델 선택이 쓴다 |
